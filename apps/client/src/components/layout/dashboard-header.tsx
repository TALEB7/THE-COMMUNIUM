  ...
  return (
    <header className="sticky top-0 z-30 bg-card dark:bg-[#0a0a0a]/95 dark:backdrop-blur-xl border-b border-border dark:border-[#1a1a1a]">
      <div className="flex items-center justify-between px-4 sm:px-6 py-3">
        {/* LEFT — Mobile menu + Brand + Profile */}
        ...
        <div className="flex items-center gap-1">
          ...
          >
            ...
            {unread > 0 && (
              <span className="absolute top-1 right-1 min-w-[16px] h-4 px-0.5 bg-destructive text-white text-[9px] font-bold rounded-full flex items-center justify-center leading-none">
                {unread > 99 ? '99+' : unread}
              </span>
            )}
          </Link>
